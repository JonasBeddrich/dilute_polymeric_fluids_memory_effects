...
int main(int argc, char *argv[])
{
    ...
    dataCollection.SetPrefixPath("ParaView/TFNSFP_Case_tauofpsi" + std::to_string(setup.run_case));
    ...
    Array2D<ParGridFunction *> &extra_stress_gf = fp_solver.GetExtrapolatedExtraStress();
